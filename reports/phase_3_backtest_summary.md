# AAGAM Phase 3: ML Engines & Adaptive Blend Backtest Summary

## FR-BLEND-2 Validation Selection Decisions

| variable | lead_days | val_mae_ridge | val_mae_lgbm | relative_diff_pct | selected_engine | rationale |
| --- | --- | --- | --- | --- | --- | --- |
| rain_mm | 1 | 1.9941 | 1.8008 | 10.733 | lgbm | LightGBM validation MAE (1.8008) beats Ridge (1.9941) by 10.73% (> 2.0%). |
| rain_mm | 2 | 2.1632 | 1.9202 | 12.656 | lgbm | LightGBM validation MAE (1.9202) beats Ridge (2.1632) by 12.66% (> 2.0%). |
| rain_mm | 3 | 2.2476 | 1.9554 | 14.94 | lgbm | LightGBM validation MAE (1.9554) beats Ridge (2.2476) by 14.94% (> 2.0%). |
| rain_mm | 4 | 2.2871 | 2.002 | 14.238 | lgbm | LightGBM validation MAE (2.0020) beats Ridge (2.2871) by 14.24% (> 2.0%). |
| rain_mm | 5 | 2.2177 | 2.0125 | 10.197 | lgbm | LightGBM validation MAE (2.0125) beats Ridge (2.2177) by 10.20% (> 2.0%). |
| rain_mm | 6 | 2.2331 | 2.0636 | 8.215 | lgbm | LightGBM validation MAE (2.0636) beats Ridge (2.2331) by 8.21% (> 2.0%). |
| rain_mm | 7 | 2.3622 | 2.1237 | 11.229 | lgbm | LightGBM validation MAE (2.1237) beats Ridge (2.3622) by 11.23% (> 2.0%). |
| tmax_c | 1 | 0.9216 | 0.8389 | 9.859 | lgbm | LightGBM validation MAE (0.8389) beats Ridge (0.9216) by 9.86% (> 2.0%). |
| tmax_c | 2 | 1.0288 | 0.904 | 13.806 | lgbm | LightGBM validation MAE (0.9040) beats Ridge (1.0288) by 13.81% (> 2.0%). |
| tmax_c | 3 | 1.1439 | 0.9494 | 20.491 | lgbm | LightGBM validation MAE (0.9494) beats Ridge (1.1439) by 20.49% (> 2.0%). |
| tmax_c | 4 | 1.236 | 1.0168 | 21.566 | lgbm | LightGBM validation MAE (1.0168) beats Ridge (1.2360) by 21.57% (> 2.0%). |
| tmax_c | 5 | 1.2891 | 1.1049 | 16.665 | lgbm | LightGBM validation MAE (1.1049) beats Ridge (1.2891) by 16.67% (> 2.0%). |
| tmax_c | 6 | 1.356 | 1.132 | 19.787 | lgbm | LightGBM validation MAE (1.1320) beats Ridge (1.3560) by 19.79% (> 2.0%). |
| tmax_c | 7 | 1.4469 | 1.219 | 18.694 | lgbm | LightGBM validation MAE (1.2190) beats Ridge (1.4469) by 18.69% (> 2.0%). |
| wind_max_kmh | 1 | 2.327 | 1.877 | 23.975 | lgbm | LightGBM validation MAE (1.8770) beats Ridge (2.3270) by 23.97% (> 2.0%). |
| wind_max_kmh | 2 | 2.414 | 1.9603 | 23.148 | lgbm | LightGBM validation MAE (1.9603) beats Ridge (2.4140) by 23.15% (> 2.0%). |
| wind_max_kmh | 3 | 2.4422 | 2.0055 | 21.776 | lgbm | LightGBM validation MAE (2.0055) beats Ridge (2.4422) by 21.78% (> 2.0%). |
| wind_max_kmh | 4 | 2.5013 | 2.0551 | 21.708 | lgbm | LightGBM validation MAE (2.0551) beats Ridge (2.5013) by 21.71% (> 2.0%). |
| wind_max_kmh | 5 | 2.5757 | 2.1101 | 22.067 | lgbm | LightGBM validation MAE (2.1101) beats Ridge (2.5757) by 22.07% (> 2.0%). |
| wind_max_kmh | 6 | 2.7287 | 2.1875 | 24.74 | lgbm | LightGBM validation MAE (2.1875) beats Ridge (2.7287) by 24.74% (> 2.0%). |
| wind_max_kmh | 7 | 3.0239 | 2.2747 | 32.936 | lgbm | LightGBM validation MAE (2.2747) beats Ridge (3.0239) by 32.94% (> 2.0%). |
...
| rain_mm | Ridge | 6.2493 | 11.7537 | 0.2093 | 25200 | overall | all |
| rain_mm | LightGBM | 5.4926 | 11.456 | -2.5206 | 25200 | overall | all |
| rain_mm | Adaptive Blend | 5.4926 | 11.456 | -2.5206 | 25200 | overall | all |
...
| tmax_c | Ridge | 1.0153 | 1.3268 | -0.4091 | 25200 | overall | all |
| tmax_c | LightGBM | 0.9002 | 1.2137 | 0.1701 | 25200 | overall | all |
| tmax_c | Adaptive Blend | 0.9002 | 1.2137 | 0.1701 | 25200 | overall | all |
...
| wind_max_kmh | Ridge | 2.6328 | 3.4979 | -0.8474 | 25200 | overall | all |
| wind_max_kmh | LightGBM | 2.0816 | 2.7634 | 0.066 | 25200 | overall | all |
| wind_max_kmh | Adaptive Blend | 2.0816 | 2.7634 | 0.066 | 25200 | overall | all |
...
| rain_mm | 1 | Ridge | 5.1683 | 9.5601 | 0.8214 | 3600 | lead_days | 1 |
| rain_mm | 1 | LightGBM | 4.6849 | 9.9359 | -2.1951 | 3600 | lead_days | 1 |
| rain_mm | 1 | Adaptive Blend | 4.6849 | 9.9359 | -2.1951 | 3600 | lead_days | 1 |
...
| rain_mm | 2 | Ridge | 5.5829 | 10.1089 | 0.9451 | 3600 | lead_days | 2 |
| rain_mm | 2 | LightGBM | 5.0519 | 10.5846 | -2.1917 | 3600 | lead_days | 2 |
| rain_mm | 2 | Adaptive Blend | 5.0519 | 10.5846 | -2.1917 | 3600 | lead_days | 2 |
...
| rain_mm | 3 | Ridge | 6.1139 | 11.1783 | 1.0599 | 3600 | lead_days | 3 |
| rain_mm | 3 | LightGBM | 5.3174 | 11.1135 | -2.2838 | 3600 | lead_days | 3 |
| rain_mm | 3 | Adaptive Blend | 5.3174 | 11.1135 | -2.2838 | 3600 | lead_days | 3 |
...
| rain_mm | 4 | Ridge | 6.4349 | 12.144 | 0.7479 | 3600 | lead_days | 4 |
| rain_mm | 4 | LightGBM | 5.5628 | 11.5913 | -2.5292 | 3600 | lead_days | 4 |
| rain_mm | 4 | Adaptive Blend | 5.5628 | 11.5913 | -2.5292 | 3600 | lead_days | 4 |
...
| rain_mm | 5 | Ridge | 6.4194 | 12.2492 | -0.4888 | 3600 | lead_days | 5 |
| rain_mm | 5 | LightGBM | 5.7532 | 11.9519 | -2.8215 | 3600 | lead_days | 5 |
| rain_mm | 5 | Adaptive Blend | 5.7532 | 11.9519 | -2.8215 | 3600 | lead_days | 5 |
...
| rain_mm | 6 | Ridge | 6.7916 | 12.8003 | -0.7442 | 3600 | lead_days | 6 |
| rain_mm | 6 | LightGBM | 5.9273 | 12.2441 | -2.868 | 3600 | lead_days | 6 |
| rain_mm | 6 | Adaptive Blend | 5.9273 | 12.2441 | -2.868 | 3600 | lead_days | 6 |
...
| rain_mm | 7 | Ridge | 7.2338 | 13.6801 | -0.8762 | 3600 | lead_days | 7 |
| rain_mm | 7 | LightGBM | 6.1506 | 12.5414 | -2.7549 | 3600 | lead_days | 7 |
| rain_mm | 7 | Adaptive Blend | 6.1506 | 12.5414 | -2.7549 | 3600 | lead_days | 7 |
...
| tmax_c | 1 | Ridge | 0.8079 | 1.0523 | -0.3071 | 3600 | lead_days | 1 |
| tmax_c | 1 | LightGBM | 0.75 | 0.9886 | 0.2514 | 3600 | lead_days | 1 |
| tmax_c | 1 | Adaptive Blend | 0.75 | 0.9886 | 0.2514 | 3600 | lead_days | 1 |
...
| tmax_c | 2 | Ridge | 0.8976 | 1.1715 | -0.3664 | 3600 | lead_days | 2 |
| tmax_c | 2 | LightGBM | 0.801 | 1.072 | 0.172 | 3600 | lead_days | 2 |
| tmax_c | 2 | Adaptive Blend | 0.801 | 1.072 | 0.172 | 3600 | lead_days | 2 |
...
| tmax_c | 3 | Ridge | 0.9667 | 1.2603 | -0.363 | 3600 | lead_days | 3 |
| tmax_c | 3 | LightGBM | 0.8641 | 1.1512 | 0.137 | 3600 | lead_days | 3 |
| tmax_c | 3 | Adaptive Blend | 0.8641 | 1.1512 | 0.137 | 3600 | lead_days | 3 |
...
| tmax_c | 4 | Ridge | 1.0196 | 1.315 | -0.3605 | 3600 | lead_days | 4 |
| tmax_c | 4 | LightGBM | 0.9104 | 1.2236 | 0.1502 | 3600 | lead_days | 4 |
| tmax_c | 4 | Adaptive Blend | 0.9104 | 1.2236 | 0.1502 | 3600 | lead_days | 4 |
...
| tmax_c | 5 | Ridge | 1.0338 | 1.3459 | -0.3346 | 3600 | lead_days | 5 |
| tmax_c | 5 | LightGBM | 0.9474 | 1.2757 | 0.1595 | 3600 | lead_days | 5 |
| tmax_c | 5 | Adaptive Blend | 0.9474 | 1.2757 | 0.1595 | 3600 | lead_days | 5 |
...
| tmax_c | 6 | Ridge | 1.1399 | 1.4701 | -0.5079 | 3600 | lead_days | 6 |
| tmax_c | 6 | LightGBM | 0.9887 | 1.3325 | 0.1493 | 3600 | lead_days | 6 |
| tmax_c | 6 | Adaptive Blend | 0.9887 | 1.3325 | 0.1493 | 3600 | lead_days | 6 |
...
| tmax_c | 7 | Ridge | 1.2418 | 1.5975 | -0.6245 | 3600 | lead_days | 7 |
| tmax_c | 7 | LightGBM | 1.0402 | 1.3998 | 0.1715 | 3600 | lead_days | 7 |
| tmax_c | 7 | Adaptive Blend | 1.0402 | 1.3998 | 0.1715 | 3600 | lead_days | 7 |
...
| wind_max_kmh | 1 | Ridge | 2.1732 | 2.918 | -0.8213 | 3600 | lead_days | 1 |
| wind_max_kmh | 1 | LightGBM | 1.7455 | 2.3168 | 0.0731 | 3600 | lead_days | 1 |
| wind_max_kmh | 1 | Adaptive Blend | 1.7455 | 2.3168 | 0.0731 | 3600 | lead_days | 1 |
...
| wind_max_kmh | 2 | Ridge | 2.348 | 3.1408 | -0.8804 | 3600 | lead_days | 2 |
| wind_max_kmh | 2 | LightGBM | 1.8804 | 2.4949 | 0.115 | 3600 | lead_days | 2 |
| wind_max_kmh | 2 | Adaptive Blend | 1.8804 | 2.4949 | 0.115 | 3600 | lead_days | 2 |
...
| wind_max_kmh | 3 | Ridge | 2.4916 | 3.2891 | -0.9223 | 3600 | lead_days | 3 |
| wind_max_kmh | 3 | LightGBM | 2.0103 | 2.635 | 0.0856 | 3600 | lead_days | 3 |
| wind_max_kmh | 3 | Adaptive Blend | 2.0103 | 2.635 | 0.0856 | 3600 | lead_days | 3 |
...
| wind_max_kmh | 4 | Ridge | 2.6254 | 3.4841 | -0.9203 | 3600 | lead_days | 4 |
| wind_max_kmh | 4 | LightGBM | 2.095 | 2.7627 | 0.0284 | 3600 | lead_days | 4 |
| wind_max_kmh | 4 | Adaptive Blend | 2.095 | 2.7627 | 0.0284 | 3600 | lead_days | 4 |
...
| wind_max_kmh | 5 | Ridge | 2.7268 | 3.5977 | -0.9095 | 3600 | lead_days | 5 |
| wind_max_kmh | 5 | LightGBM | 2.1917 | 2.8937 | 0.0245 | 3600 | lead_days | 5 |
| wind_max_kmh | 5 | Adaptive Blend | 2.1917 | 2.8937 | 0.0245 | 3600 | lead_days | 5 |
...
| wind_max_kmh | 6 | Ridge | 2.8427 | 3.7556 | -1.0501 | 3600 | lead_days | 6 |
| wind_max_kmh | 6 | LightGBM | 2.288 | 3.0355 | 0.0801 | 3600 | lead_days | 6 |
| wind_max_kmh | 6 | Adaptive Blend | 2.288 | 3.0355 | 0.0801 | 3600 | lead_days | 6 |
...
| wind_max_kmh | 7 | Ridge | 3.2219 | 4.1552 | -0.4282 | 3600 | lead_days | 7 |
| wind_max_kmh | 7 | LightGBM | 2.3603 | 3.1143 | 0.0551 | 3600 | lead_days | 7 |
| wind_max_kmh | 7 | Adaptive Blend | 2.3603 | 3.1143 | 0.0551 | 3600 | lead_days | 7 |
...
| rain_mm | CENTRAL | Ridge | 6.2561 | 10.5972 | -0.207 | 4410 | region | CENTRAL |
| rain_mm | CENTRAL | LightGBM | 5.7884 | 10.5214 | -2.5225 | 4410 | region | CENTRAL |
| rain_mm | CENTRAL | Adaptive Blend | 5.7884 | 10.5214 | -2.5225 | 4410 | region | CENTRAL |
...
| rain_mm | EAST_NE | Ridge | 8.941 | 15.3054 | 0.9301 | 6300 | region | EAST_NE |
| rain_mm | EAST_NE | LightGBM | 7.7225 | 15.1935 | -3.3469 | 6300 | region | EAST_NE |
| rain_mm | EAST_NE | Adaptive Blend | 7.7225 | 15.1935 | -3.3469 | 6300 | region | EAST_NE |
...
| rain_mm | HIMALAYAN | Ridge | 6.589 | 11.5127 | 0.669 | 3780 | region | HIMALAYAN |
| rain_mm | HIMALAYAN | LightGBM | 5.5217 | 10.6794 | -2.7478 | 3780 | region | HIMALAYAN |
| rain_mm | HIMALAYAN | Adaptive Blend | 5.5217 | 10.6794 | -2.7478 | 3780 | region | HIMALAYAN |
...
| rain_mm | NW | Ridge | 5.15 | 11.2416 | 0.5708 | 5670 | region | NW |
| rain_mm | NW | LightGBM | 4.2865 | 10.5066 | -1.9638 | 5670 | region | NW |
| rain_mm | NW | Adaptive Blend | 4.2865 | 10.5066 | -1.9638 | 5670 | region | NW |
...
| rain_mm | SOUTH | Ridge | 3.8604 | 7.622 | -1.079 | 5040 | region | SOUTH |
| rain_mm | SOUTH | LightGBM | 3.7813 | 7.814 | -1.9422 | 5040 | region | SOUTH |
| rain_mm | SOUTH | Adaptive Blend | 3.7813 | 7.814 | -1.9422 | 5040 | region | SOUTH |
...
| tmax_c | CENTRAL | Ridge | 1.0239 | 1.3456 | -0.5693 | 4410 | region | CENTRAL |
| tmax_c | CENTRAL | LightGBM | 0.8622 | 1.1589 | 0.0114 | 4410 | region | CENTRAL |
| tmax_c | CENTRAL | Adaptive Blend | 0.8622 | 1.1589 | 0.0114 | 4410 | region | CENTRAL |
...
| tmax_c | EAST_NE | Ridge | 1.0005 | 1.2754 | -0.5422 | 6300 | region | EAST_NE |
| tmax_c | EAST_NE | LightGBM | 0.8032 | 1.0634 | 0.1765 | 6300 | region | EAST_NE |
| tmax_c | EAST_NE | Adaptive Blend | 0.8032 | 1.0634 | 0.1765 | 6300 | region | EAST_NE |
...
| tmax_c | HIMALAYAN | Ridge | 1.1273 | 1.4695 | -0.2411 | 3780 | region | HIMALAYAN |
| tmax_c | HIMALAYAN | LightGBM | 1.045 | 1.4153 | 0.3165 | 3780 | region | HIMALAYAN |
| tmax_c | HIMALAYAN | Adaptive Blend | 1.045 | 1.4153 | 0.3165 | 3780 | region | HIMALAYAN |
...
| tmax_c | NW | Ridge | 0.9725 | 1.3012 | -0.2763 | 5670 | region | NW |
| tmax_c | NW | LightGBM | 0.8942 | 1.2324 | 0.2781 | 5670 | region | NW |
| tmax_c | NW | Adaptive Blend | 0.8942 | 1.2324 | 0.2781 | 5670 | region | NW |
...
| tmax_c | SOUTH | Ridge | 0.9904 | 1.2883 | -0.3781 | 5040 | region | SOUTH |
| tmax_c | SOUTH | LightGBM | 0.9531 | 1.2512 | 0.0699 | 5040 | region | SOUTH |
| tmax_c | SOUTH | Adaptive Blend | 0.9531 | 1.2512 | 0.0699 | 5040 | region | SOUTH |
...
| wind_max_kmh | CENTRAL | Ridge | 2.5852 | 3.4987 | -0.2068 | 4410 | region | CENTRAL |
| wind_max_kmh | CENTRAL | LightGBM | 2.1296 | 2.7619 | 0.3495 | 4410 | region | CENTRAL |
| wind_max_kmh | CENTRAL | Adaptive Blend | 2.1296 | 2.7619 | 0.3495 | 4410 | region | CENTRAL |
...
| wind_max_kmh | EAST_NE | Ridge | 2.9747 | 3.8832 | -2.2317 | 6300 | region | EAST_NE |
| wind_max_kmh | EAST_NE | LightGBM | 2.2707 | 2.9767 | -0.3124 | 6300 | region | EAST_NE |
| wind_max_kmh | EAST_NE | Adaptive Blend | 2.2707 | 2.9767 | -0.3124 | 6300 | region | EAST_NE |
...
| wind_max_kmh | HIMALAYAN | Ridge | 2.0927 | 2.8053 | -1.2761 | 3780 | region | HIMALAYAN |
| wind_max_kmh | HIMALAYAN | LightGBM | 1.6202 | 2.1653 | 0.0073 | 3780 | region | HIMALAYAN |
| wind_max_kmh | HIMALAYAN | Adaptive Blend | 1.6202 | 2.1653 | 0.0073 | 3780 | region | HIMALAYAN |
...
| wind_max_kmh | NW | Ridge | 2.5655 | 3.4029 | 0.4942 | 5670 | region | NW |
| wind_max_kmh | NW | LightGBM | 2.0756 | 2.8328 | 0.0571 | 5670 | region | NW |
| wind_max_kmh | NW | Adaptive Blend | 2.0756 | 2.8328 | 0.0571 | 5670 | region | NW |
...
| wind_max_kmh | SOUTH | Ridge | 2.7278 | 3.5621 | -0.8654 | 5040 | region | SOUTH |
| wind_max_kmh | SOUTH | LightGBM | 2.1559 | 2.8084 | 0.3449 | 5040 | region | SOUTH |
| wind_max_kmh | SOUTH | Adaptive Blend | 2.1559 | 2.8084 | 0.3449 | 5040 | region | SOUTH |